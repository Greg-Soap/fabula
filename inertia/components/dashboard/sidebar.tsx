...
const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { title: 'Series', href: '/dashboard/series', icon: <Film className='h-4 w-4' /> },
      { title: 'Novels', href: '/dashboard/novels', icon: <BookOpen className='h-4 w-4' /> },
    ],
  },
]
      ...
      <div className='flex h-14 items-center px-3'>
        <div className='flex flex-1 items-center justify-center min-w-0'>
          <Link
            href='/'
            className={cn(
              'font-heading font-normal tracking-tight text-sidebar-foreground hover:text-sidebar-primary',
              isOpen || isMobile ? 'text-lg' : 'text-xl',
            )}
            title='Fabula'>
            {isOpen || isMobile ? (
              <span>Fabula</span>
            ) : (
              <span className='block text-center'>F</span>
            )}
          </Link>
        </div>
        ...
        <div className='sticky top-0 z-30 border-b border-border bg-background'>
          <div className='w-full flex h-16 items-center justify-between gap-2 px-4 sm:px-6'>
            <div className='flex items-center gap-2'>
              {isMobile ? (
                <Button variant='ghost' size='icon' onClick={openMobileMenu} className='md:hidden'>
